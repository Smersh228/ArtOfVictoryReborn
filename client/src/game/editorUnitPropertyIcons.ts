...
import medicalImg from '../img/propertis/medical.png';
import mineDetectionImg from '../img/propertis/mineDetection.png';
import shootingInMotionImg from '../img/propertis/shootingInMotion.png';
...
export const EDITOR_UNIT_PROPERTY_DEFS: EditorUnitPropertyDef[] = [
  ...
  { prop_key: 'medical', name: 'Лечение', icon: medicalImg },
  ...
  { prop_key: 'shootingInMotion', name: 'Стрельба в движении', icon: shootingInMotionImg },
