...
const ORDER_LABEL_RU = {
  ...
  medical: 'медик',
  fireAdjustment: 'корректировка огня',
  razvedka: 'разведка',
  svzy: 'радиоперехват',
  getSup: 'передача припасов',
  loadingSup: 'погрузка припасов',
  loading: 'погрузка',
  unloading: 'выгрузка',
  tow: 'буксир',
...
function orderFingerprint(spec) {
  ...
  return JSON.stringify({
    ...
    tm: spec.transferMines ?? null,
    te: spec.transferExplosives ?? null,
    ts: spec.transferSmoke ?? null,
